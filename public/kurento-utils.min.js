...
!function(i,e){"use strict";var o="model",a="name",r="type",t="vendor",n="version",s="mobile",b="tablet",w="smarttv",d=function(i,e){var o={};for(var a in i)e[a]&&e[a].length%2==0?o[a]=e[a].concat(i[a]):o[a]=i[a];return o},l=function(i){for(var e={},o=0;o<i.length;o++)e[i[o].toUpperCase()]=i[o];return e},c=function(i,e){return"string"==typeof i&&-1!==u(e).indexOf(u(i))},u=function(i){return i.toLowerCase()},m=function(i){return"string"==typeof i?i.replace(/[^\d\.]/g,"").split(".")[0]:void 0},p=function(i,e){if("string"==typeof i)return i=i.replace(/^\s\s*/,""),void 0===e?i:i.substring(0,350)},h=function(i,e){for(var o,a,r,t,n,s,b=0;b<e.length&&!n;){var w=e[b],d=e[b+1];for(o=a=0;o<w.length&&!n&&w[o];)if(n=w[o++].exec(i))for(r=0;r<d.length;r++)s=n[++a],t=d[r],"object"==typeof t&&t.length>0?2===t.length?"function"==typeof t[1]?this[t[0]]=t[1].call(this,s):this[t[0]]=t[1]:3===t.length?"function"!=typeof t[1]||t[1].exec&&t[1].test?this[t[0]]=s?s.replace(t[1],t[2]):void 0:this[t[0]]=s?t[1].call(this,s,t[2]):void 0:4===t.length&&(this[t[0]]=s?t[3].call(this,s.replace(t[1],t[2])):void 0):this[t]=s||void 0;b+=2}},v=function(i,e){for(var o in e)if("object"==typeof e[o]&&e[o].length>0){for(var a=0;a<e[o].length;a++)if(c(e[o][a],i))return"?"===o?void 0:o}else if(c(e[o],i))return"?"===o?void 0:o;return i},f={"1.0":"/8",1.2:"/1",1.3:"/3","2.0":"/412","2.0.2":"/416","2.0.3":"/417","2.0.4":"/419","?":"/"},g={ME:"4.90","NT 3.11":"NT3.51","NT 4.0":"NT4.0",2000:"NT 5.0",XP:["NT 5.1","NT 5.2"],Vista:"NT 6.0",7:"NT 6.1",8:"NT 6.2",8.1:"NT 6.3",10:["NT 6.4","NT 10.0"],RT:"ARM"},x={browser:[[/\b(?:crmo|crios)\/([\w\.]+)/i],[n,[a,"Chrome"]],[/edg(?:e|ios|a)?\/([\w\.]+)/i],[n,[a,"Edge"]],[/(opera mini)\/([-\w\.]+)/i,/(opera [mobiletab]{3,6})\b.+version\/([-\w\.]+)/i,/(opera)(?:.+version\/|[\/ ]+)([\w\.]+)/i],[a,n],[/opios[\/ ]+([\w\.]+)/i],[n,[a,"Opera Mini"]],[/\bopr\/([\w\.]+)/i],[n,[a,"Opera"]],[/(kindle)\/([\w\.]+)/i,/(lunascape|maxthon|netfront|jasmine|blazer)[\/ ]?([\w\.]*)/i,/(avant |iemobile|slim)(?:browser)?[\/ ]?([\w\.]*)/i,/(ba?idubrowser)[\/ ]?([\w\.]+)/i,/(?:ms|\()(ie) ([\w\.]+)/i,/(flock|rockmelt|midori|epiphany|silk|skyfire|ovibrowser|bolt|iron|vivaldi|iridium|phantomjs|bowser|quark|qupzilla|falkon|rekonq|puffin|brave|whale(?!.+naver)|qqbrowserlite|qq|duckduckgo)\/([-\w\.]+)/i,/(weibo)__([\d\.]+)/i],[a,n],[/(?:\buc? ?browser|(?:juc.+)ucweb)[\/ ]?([\w\.]+)/i],[n,[a,"UCBrowser"]],[/microm.+\bqbcore\/([\w\.]+)/i,/\bqbcore\/([\w\.]+).+microm/i],[n,[a,"WeChat(Win) Desktop"]],[/micromessenger\/([\w\.]+)/i],[n,[a,"WeChat"]],[/konqueror\/([\w\.]+)/i],[n,[a,"Konqueror"]],[/trident.+rv[: ]([\w\.]{1,9})\b.+like gecko/i],[n,[a,"IE"]],[/yabrowser\/([\w\.]+)/i],[n,[a,"Yandex"]],[/(avast|avg)\/([\w\.]+)/i],[[a,/(.+)/,"$1 Secure Browser"],n],[/\bfocus\/([\w\.]+)/i],[n,[a,"Firefox Focus"]],[/\bopt\/([\w\.]+)/i],[n,[a,"Opera Touch"]],[/coc_coc\w+\/([\w\.]+)/i],[n,[a,"Coc Coc"]],[/dolfin\/([\w\.]+)/i],[n,[a,"Dolphin"]],[/coast\/([\w\.]+)/i],[n,[a,"Opera Coast"]],[/miuibrowser\/([\w\.]+)/i],[n,[a,"MIUI Browser"]],[/fxios\/([-\w\.]+)/i],[n,[a,"Firefox"]],[/\bqihu|(qi?ho?o?|360)browser/i],[[a,"360 Browser"]],[/(oculus|samsung|sailfish|huawei)browser\/([\w\.]+)/i],[[a,/(.+)/,"$1 Browser"],n],[/(comodo_dragon)\/([\w\.]+)/i],[[a,/_/g," "],n],[/(electron)\/([\w\.]+) safari/i,/(tesla)(?: qtcarbrowser|\/(20\d\d\.[-\w\.]+))/i,/m?(qqbrowser|baiduboxapp|2345Explorer)[\/ ]?([\w\.]+)/i],[a,n],[/(metasr)[\/ ]?([\w\.]+)/i,/(lbbrowser)/i,/\[(linkedin)app\]/i],[a],[/((?:fban\/fbios|fb_iab\/fb4a)(?!.+fbav)|;fbav\/([\w\.]+);)/i],[[a,"Facebook"],n],[/(kakao(?:talk|story))[\/ ]([\w\.]+)/i,/(naver)\(.*?(\d+\.[\w\.]+).*\)/i,/safari (line)\/([\w\.]+)/i,/\b(line)\/([\w\.]+)\/iab/i,/(chromium|instagram)[\/ ]([-\w\.]+)/i],[a,n],[/\bgsa\/([\w\.]+) .*safari\//i],[n,[a,"GSA"]],[/headlesschrome(?:\/([\w\.]+)| )/i],[n,[a,"Chrome Headless"]],[/ wv\).+(chrome)\/([\w\.]+)/i],[[a,"Chrome WebView"],n],[/droid.+ version\/([\w\.]+)\b.+(?:mobile safari|safari)/i],[n,[a,"Android Browser"]],[/(chrome|omniweb|arora|[tizenoka]{5} ?browser)\/v?([\w\.]+)/i],[a,n],[/version\/([\w\.\,]+) .*mobile\/\w+ (safari)/i],[n,[a,"Mobile Safari"]],[/version\/([\w(\.|\,)]+) .*(mobile ?safari|safari)/i],[n,a],[/webkit.+?(mobile ?safari|safari)(\/[\w\.]+)/i],[a,[n,v,f]],[/(webkit|khtml)\/([\w\.]+)/i],[a,n],[/(navigator|netscape\d?)\/([-\w\.]+)/i],[[a,"Netscape"],n],[/mobile vr; rv:([\w\.]+)\).+firefox/i],[n,[a,"Firefox Reality"]],[/ekiohf.+(flow)\/([\w\.]+)/i,/(swiftfox)/i,/(icedragon|iceweasel|camino|chimera|fennec|maemo browser|minimo|conkeror|klar)[\/ ]?([\w\.\+]+)/i,/(seamonkey|k-meleon|icecat|iceape|firebird|phoenix|palemoon|basilisk|waterfox)\/([-\w\.]+)$/i,/(firefox)\/([\w\.]+)/i,/(mozilla)\/([\w\.]+) .+rv\:.+gecko\/\d+/i,/(polaris|lynx|dillo|icab|doris|amaya|w3m|netsurf|sleipnir|obigo|mosaic|(?:go|ice|up)[\. ]?browser)[-\/ ]?v?([\w\.]+)/i,/(links) \(([\w\.]+)/i,/panasonic;(viera)/i],[a,n],[/(cobalt)\/([\w\.]+)/i],[a,[n,/master.|lts./,""]]],cpu:[[/(?:(amd|x(?:(?:86|64)[-_])?|wow|win)64)[;\)]/i],[["architecture","amd64"]],[/(ia32(?=;))/i],[["architecture",u]],[/((?:i[346]|x)86)[;\)]/i],[["architecture","ia32"]],[/\b(aarch64|arm(v?8e?l?|_?64))\b/i],[["architecture","arm64"]],[/\b(arm(?:v[67])?ht?n?[fl]p?)\b/i],[["architecture","armhf"]],[/windows (ce|mobile); ppc;/i],[["architecture","arm"]],[/((?:ppc|powerpc)(?:64)?)(?: mac|;|\))/i],[["architecture",/ower/,"",u]],[/(sun4\w)[;\)]/i],[["architecture","sparc"]],[/((?:avr32|ia64(?=;))|68k(?=\))|\barm(?=v(?:[1-7]|[5-7]1)l?|;|eabi)|(?=atmel )avr|(?:irix|mips|sparc)(?:64)?\b|pa-risc)/i],[["architecture",u]]],device:[[/\b(sch-i[89]0\d|shw-m380s|sm-[ptx]\w{2,4}|gt-[pn]\d{2,4}|sgh-t8[56]9|nexus 10)/i],[o,[t,"Samsung"],[r,b]],[/\b((?:s[cgp]h|gt|sm)-\w+|sc[g-]?[\d]+a?|galaxy nexus)/i,/samsung[- ]([-\w]+)/i,/sec-(sgh\w+)/i],[o,[t,"Samsung"],[r,s]],[/\((ip(?:hone|od)[\w ]*);/i],[o,[t,"Apple"],[r,s]],[/\((ipad);[-\w\),; ]+apple/i,/applecoremedia\/[\w\.]+ \((ipad)/i,/\b(ipad)\d\d?,\d\d?[;\]].+ios/i],[o,[t,"Apple"],[r,b]],[/(macintosh);/i],[o,[t,"Apple"]],[/\b(sh-?[altvz]?\d\d[a-ekm]?)/i],[o,[t,"Sharp"],[r,s]],[/\b((?:ag[rs][23]?|bah2?|sht?|btv)-a?[lw]\d{2})\b(?!.+d\/s)/i],[o,[t,"Huawei"],[r,b]],[/(?:huawei|honor)([-\w ]+)[;\)]/i,/\b(nexus 6p|\w{2,4}e?-[atu]?[ln][\dx][012359c][adn]?)\b(?!.+d\/s)/i],[o,[t,"Huawei"],[r,s]],[/\b(poco[\w ]+)(?: bui|\))/i,/\b; (\w+) build\/hm\1/i,/\b(hm[-_ ]?note?[_ ]?(?:\d\w)?) bui/i,/\b(redmi[\-_ ]?(?:note|k)?[\w_ ]+)(?: bui|\))/i,/\b(mi[-_ ]?(?:a\d|one|one[_ ]plus|note lte|max|cc)?[_ ]?(?:\d?\w?)[_ ]?(?:plus|se|lite)?)(?: bui|\))/i],[[o,/_/g," "],[t,"Xiaomi"],[r,s]],[/\b(mi[-_ ]?(?:pad)(?:[\w_ ]+))(?: bui|\))/i],[[o,/_/g," "],[t,"Xiaomi"],[r,b]],[/; (\w+) bui.+ oppo/i,/\b(cph[12]\d{3}|p(?:af|c[al]|d\w|e[ar])[mt]\d0|x9007|a101op)\b/i],[o,[t,"OPPO"],[r,s]],[/vivo (\w+)(?: bui|\))/i,/\b(v[12]\d{3}\w?[at])(?: bui|;)/i],[o,[t,"Vivo"],[r,s]],[/\b(rmx[12]\d{3})(?: bui|;|\))/i],[o,[t,"Realme"],[r,s]],[/\b(milestone|droid(?:[2-4x]| (?:bionic|x2|pro|razr))?:?( 4g)?)\b[\w ]+build\//i,/\bmot(?:orola)?[- ](\w*)/i,/((?:moto[\w\(\) ]+|xt\d{3,4}|nexus 6)(?= bui|\)))/i],[o,[t,"Motorola"],[r,s]],[/\b(mz60\d|xoom[2 ]{0,2}) build\//i],[o,[t,"Motorola"],[r,b]],[/((?=lg)?[vl]k\-?\d{3}) bui| 3\.[-\w; ]{10}lg?-([06cv9]{3,4})/i],[o,[t,"LG"],[r,b]],[/(lm(?:-?f100[nv]?|-[\w\.]+)(?= bui|\))|nexus [45])/i,/\blg[-e;\/ ]+((?!browser|netcast|android tv)\w+)/i,/\blg-?([\d\w]+) bui/i],[o,[t,"LG"],[r,s]],[/(ideatab[-\w ]+)/i,/lenovo ?(s[56]000[-\w]+|tab(?:[\w ]+)|yt[-\d\w]{6}|tb[-\d\w]{6})/i],[o,[t,"Lenovo"],[r,b]],[/(?:maemo|nokia).*(n900|lumia \d+)/i,/nokia[-_ ]?([-\w\.]*)/i],[[o,/_/g," "],[t,"Nokia"],[r,s]],[/(pixel c)\b/i],[o,[t,"Google"],[r,b]],[/droid.+; (pixel[\daxl ]{0,6})(?: bui|\))/i],[o,[t,"Google"],[r,s]],[/droid.+ (a?\d[0-2]{2}so|[c-g]\d{4}|so[-gl]\w+|xq-a\w[4-7][12])(?= bui|\).+chrome\/(?![1-6]{0,1}\d\.))/i],[o,[t,"Sony"],[r,s]],[/sony tablet [ps]/i,/\b(?:sony)?sgp\w+(?: bui|\))/i],[[o,"Xperia Tablet"],[t,"Sony"],[r,b]],[/ (kb2005|in20[12]5|be20[12][59])\b/i,/(?:one)?(?:plus)? (a\d0\d\d)(?: b|\))/i],[o,[t,"OnePlus"],[r,s]],[/(alexa)webm/i,/(kf[a-z]{2}wi)( bui|\))/i,/(kf[a-z]+)( bui|\)).+silk\//i],[o,[t,"Amazon"],[r,b]],[/((?:sd|kf)[0349hijorstuw]+)( bui|\)).+silk\//i],[[o,/(.+)/g,"Fire Phone $1"],[t,"Amazon"],[r,s]],[/(playbook);[-\w\),; ]+(rim)/i],[o,t,[r,b]],[/\b((?:bb[a-f]|st[hv])100-\d)/i,/\(bb10; (\w+)/i],[o,[t,"BlackBerry"],[r,s]],[/(?:\b|asus_)(transfo[prime ]{4,10} \w+|eeepc|slider \w+|nexus 7|padfone|p00[cj])/i],[o,[t,"ASUS"],[r,b]],[/ (z[bes]6[027][012][km][ls]|zenfone \d\w?)\b/i],[o,[t,"ASUS"],[r,s]],[/(nexus 9)/i],[o,[t,"HTC"],[r,b]],[/(htc)[-;_ ]{1,2}([\w ]+(?=\)| bui)|\w+)/i,/(zte)[- ]([\w ]+?)(?: bui|\/|\))/i,/(alcatel|geeksphone|nexian|panasonic(?!(?:;|\.))|sony(?!-bra))[-_ ]?([-\w]*)/i],[t,[o,/_/g," "],[r,s]],[/droid.+; ([ab][1-7]-?[0178a]\d\d?)/i],[o,[t,"Acer"],[r,b]],[/droid.+; (m[1-5] note) bui/i,/\bmz-([-\w]{2,})/i],[o,[t,"Meizu"],[r,s]],[/(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron)[-_ ]?([-\w]*)/i,/(hp) ([\w ]+\w)/i,/(asus)-?(\w+)/i,/(microsoft); (lumia[\w ]+)/i,/(lenovo)[-_ ]?([-\w]+)/i,/(jolla)/i,/(oppo) ?([\w ]+) bui/i],[t,o,[r,s]],[/(kobo)\s(ereader|touch)/i,/(archos) (gamepad2?)/i,/(hp).+(touchpad(?!.+tablet)|tablet)/i,/(kindle)\/([\w\.]+)/i,/(nook)[\w ]+build\/(\w+)/i,/(dell) (strea[kpr\d ]*[\dko])/i,/(le[- ]+pan)[- ]+(\w{1,9}) bui/i,/(trinity)[- ]*(t\d{3}) bui/i,/(gigaset)[- ]+(q\w{1,9}) bui/i,/(vodafone) ([\w ]+)(?:\)| bui)/i],[t,o,[r,b]],[/(surface duo)/i],[o,[t,"Microsoft"],[r,b]],[/droid [\d\.]+; (fp\du?)(?: b|\))/i],[o,[t,"Fairphone"],[r,s]],[/(u304aa)/i],[o,[t,"AT&T"],[r,s]],[/\bsie-(\w*)/i],[o,[t,"Siemens"],[r,s]],[/\b(rct\w+) b/i],[o,[t,"RCA"],[r,b]],[/\b(venue[\d ]{2,7}) b/i],[o,[t,"Dell"],[r,b]],[/\b(q(?:mv|ta)\w+) b/i],[o,[t,"Verizon"],[r,b]],[/\b(?:barnes[& ]+noble |bn[rt])([\w\+ ]*) b/i],[o,[t,"Barnes & Noble"],[r,b]],[/\b(tm\d{3}\w+) b/i],[o,[t,"NuVision"],[r,b]],[/\b(k88) b/i],[o,[t,"ZTE"],[r,b]],[/\b(nx\d{3}j) b/i],[o,[t,"ZTE"],[r,s]],[/\b(gen\d{3}) b.+49h/i],[o,[t,"Swiss"],[r,s]],[/\b(zur\d{3}) b/i],[o,[t,"Swiss"],[r,b]],[/\b((zeki)?tb.*\b) b/i],[o,[t,"Zeki"],[r,b]],[/\b([yr]\d{2}) b/i,/\b(dragon[- ]+touch |dt)(\w{5}) b/i],[[t,"Dragon Touch"],o,[r,b]],[/\b(ns-?\w{0,9}) b/i],[o,[t,"Insignia"],[r,b]],[/\b((nxa|next)-?\w{0,9}) b/i],[o,[t,"NextBook"],[r,b]],[/\b(xtreme\_)?(v(1[045]|2[015]|[3469]0|7[05])) b/i],[[t,"Voice"],o,[r,s]],[/\b(lvtel\-)?(v1[12]) b/i],[[t,"LvTel"],o,[r,s]],[/\b(ph-1) /i],[o,[t,"Essential"],[r,s]],[/\b(v(100md|700na|7011|917g).*\b) b/i],[o,[t,"Envizen"],[r,b]],[/\b(trio[-\w\. ]+) b/i],[o,[t,"MachSpeed"],[r,b]],[/\btu_(1491) b/i],[o,[t,"Rotor"],[r,b]],[/(shield[\w ]+) b/i],[o,[t,"Nvidia"],[r,b]],[/(sprint) (\w+)/i],[t,o,[r,s]],[/(kin\.[onetw]{3})/i],[[o,/\./g," "],[t,"Microsoft"],[r,s]],[/droid.+; (cc6666?|et5[16]|mc[239][23]x?|vc8[03]x?)\)/i],[o,[t,"Zebra"],[r,b]],[/droid.+; (ec30|ps20|tc[2-8]\d[kx])\)/i],[o,[t,"Zebra"],[r,s]],[/smart-tv.+(samsung)/i],[t,[r,w]],[/hbbtv.+maple;(\d+)/i],[[o,/^/,"SmartTV"],[t,"Samsung"],[r,w]],[/(nux; netcast.+smarttv|lg (netcast\.tv-201\d|android tv))/i],[[t,"LG"],[r,w]],[/(apple) ?tv/i],[t,[o,"Apple TV"],[r,w]],[/crkey/i],[[o,"Chromecast"],[t,"Google"],[r,w]],[/droid.+aft(\w)( bui|\))/i],[o,[t,"Amazon"],[r,w]],[/\(dtv[\);].+(aquos)/i,/(aquos-tv[\w ]+)\)/i],[o,[t,"Sharp"],[r,w]],[/(bravia[\w ]+)( bui|\))/i],[o,[t,"Sony"],[r,w]],[/(mitv-\w{5}) bui/i],[o,[t,"Xiaomi"],[r,w]],[/Hbbtv.*(technisat) (.*);/i],[t,o,[r,w]],[/\b(roku)[\dx]*[\)\/]((?:dvp-)?[\d\.]*)/i,/hbbtv\/\d+\.\d+\.\d+ +\([\w\+ ]*; *([\w\d][^;]*);([^;]*)/i],[[t,p],[o,p],[r,w]],[/\b(android tv|smart[- ]?tv|opera tv|tv; rv:)\b/i],[[r,w]],[/(ouya)/i,/(nintendo) ([wids3utch]+)/i],[t,o,[r,"console"]],[/droid.+; (shield) bui/i],[o,[t,"Nvidia"],[r,"console"]],[/(playstation [345portablevi]+)/i],[o,[t,"Sony"],[r,"console"]],[/\b(xbox(?: one)?(?!; xbox))[\); ]/i],[o,[t,"Microsoft"],[r,"console"]],[/((pebble))app/i],[t,o,[r,"wearable"]],[/(watch)(?: ?os[,\/]|\d,\d\/)[\d\.]+/i],[o,[t,"Apple"],[r,"wearable"]],[/droid.+; (glass) \d/i],[o,[t,"Google"],[r,"wearable"]],[/droid.+; (wt63?0{2,3})\)/i],[o,[t,"Zebra"],[r,"wearable"]],[/(quest( 2| pro)?)/i],[o,[t,"Facebook"],[r,"wearable"]],[/(tesla)(?: qtcarbrowser|\/[-\w\.]+)/i],[t,[r,"embedded"]],[/droid .+?; ([^;]+?)(?: bui|\) applew).+? mobile safari/i],[o,[r,s]],[/droid .+?; ([^;]+?)(?: bui|\) applew).+?(?! mobile) safari/i],[o,[r,b]],[/\b((tablet|tab)[;\/]|focus\/\d(?!.+mobile))/i],[[r,b]],[/(phone|mobile(?:[;\/]| [ \w\/\.]*safari)|pda(?=.+windows ce))/i],[[r,s]],[/(android[-\w\. ]{0,9});.+buil/i],[o,[t,"Generic"]]],engine:[[/windows.+ edge\/([\w\.]+)/i],[n,[a,"EdgeHTML"]],[/webkit\/537\.36.+chrome\/(?!27)([\w\.]+)/i],[n,[a,"Blink"]],[/(presto)\/([\w\.]+)/i,/(webkit|trident|netfront|netsurf|amaya|lynx|w3m|goanna)\/([\w\.]+)/i,/ekioh(flow)\/([\w\.]+)/i,/(khtml|tasman|links)[\/ ]\(?([\w\.]+)/i,/(icab)[\/ ]([23]\.[\d\.]+)/i],[a,n],[/rv\:([\w\.]{1,9})\b.+(gecko)/i],[n,a]],os:[[/microsoft (windows) (vista|xp)/i],[a,n],[/(windows) nt 6\.2; (arm)/i,/(windows (?:phone(?: os)?|mobile))[\/ ]?([\d\.\w ]*)/i,/(windows)[\/ ]?([ntce\d\. ]+\w)(?!.+xbox)/i],[a,[n,v,g]],[/(win(?=3|9|n)|win 9x )([nt\d\.]+)/i],[[a,"Windows"],[n,v,g]],[/ip[honead]{2,4}\b(?:.*os ([\w]+) like mac|; opera)/i,/cfnetwork\/.+darwin/i],[[n,/_/g,"."],[a,"iOS"]],[/(mac os x) ?([\w\. ]*)/i,/(macintosh|mac_powerpc\b)(?!.+haiku)/i],[[a,"Mac OS"],[n,/_/g,"."]],[/droid ([\w\.]+)\b.+(android[- ]x86|harmonyos)/i],[n,a],[/(android|webos|qnx|bada|rim tablet os|maemo|meego|sailfish)[-\/ ]?([\w\.]*)/i,/(blackberry)\w*\/([\w\.]*)/i,/(tizen|kaios)[\/ ]([\w\.]+)/i,/\((series40);/i],[a,n],[/\(bb(10);/i],[n,[a,"BlackBerry"]],[/(?:symbian ?os|symbos|s60(?=;)|series60)[-\/ ]?([\w\.]*)/i],[n,[a,"Symbian"]],[/mozilla\/[\d\.]+ \((?:mobile|tablet|tv|mobile; [\w ]+); rv:.+ gecko\/([\w\.]+)/i],[n,[a,"Firefox OS"]],[/web0s;.+rt(tv)/i,/\b(?:hp)?wos(?:browser)?\/([\w\.]+)/i],[n,[a,"webOS"]],[/watch(?: ?os[,\/]|\d,\d\/)([\d\.]+)/i],[n,[a,"watchOS"]],[/crkey\/([\d\.]+)/i],[n,[a,"Chromecast"]],[/(cros) [\w]+(?:\)| ([\w\.]+)\b)/i],[[a,"Chromium OS"],n],[/panasonic;(viera)/i,/(netrange)mmh/i,/(nettv)\/(\d+\.[\w\.]+)/i,/(nintendo|playstation) ([wids345portablevuch]+)/i,/(xbox); +xbox ([^\);]+)/i,/\b(joli|palm)\b ?(?:os)?\/?([\w\.]*)/i,/(mint)[\/\(\) ]?(\w*)/i,/(mageia|vectorlinux)[; ]/i,/([kxln]?ubuntu|debian|suse|opensuse|gentoo|arch(?= linux)|slackware|fedora|mandriva|centos|pclinuxos|red ?hat|zenwalk|linpus|raspbian|plan 9|minix|risc os|contiki|deepin|manjaro|elementary os|sabayon|linspire)(?: gnu\/linux)?(?: enterprise)?(?:[- ]linux)?(?:-gnu)?[-\/ ]?(?!chrom|package)([-\w\.]*)/i,/(hurd|linux) ?([\w\.]*)/i,/(gnu) ?([\w\.]*)/i,/\b([-frentopcghs]{0,5}bsd|dragonfly)[\/ ]?(?!amd|[ix346]{1,2}86)([\w\.]*)/i,/(haiku) (\w+)/i],[a,n],[/(sunos) ?([\w\.\d]*)/i],[[a,"Solaris"],n],[/((?:open)?solaris)[-\/ ]?([\w\.]*)/i,/(aix) ((\d)(?=\.|\)| )[\w\.])*/i,/\b(beos|os\/2|amigaos|morphos|openvms|fuchsia|hp-ux)/i,/(unix) ?([\w\.]*)/i],[a,n]]},k=function(e,w){if("object"==typeof e&&(w=e,e=void 0),!(this instanceof k))return new k(e,w).getResult();var l=void 0!==i&&i.navigator?i.navigator:void 0,c=e||(l&&l.userAgent?l.userAgent:""),u=l&&l.userAgentData?l.userAgentData:void 0,v=w?d(x,w):x;return this.getBrowser=function(){var i={};return i[a]=void 0,i[n]=void 0,h.call(i,c,v.browser),i.major=m(i[n]),l&&l.brave&&"function"==typeof l.brave.isBrave&&(i[a]="Brave"),i},this.getCPU=function(){var i={};return i.architecture=void 0,h.call(i,c,v.cpu),i},this.getDevice=function(){var i={};return i[t]=void 0,i[o]=void 0,i[r]=void 0,h.call(i,c,v.device),!i[r]&&u&&u.mobile&&(i[r]=s),"Macintosh"==i[o]&&l&&void 0!==l.standalone&&l.maxTouchPoints&&l.maxTouchPoints>2&&(i[o]="iPad",i[r]=b),i},this.getEngine=function(){var i={};return i[a]=void 0,i[n]=void 0,h.call(i,c,v.engine),i},this.getOS=function(){var i={};return i[a]=void 0,i[n]=void 0,h.call(i,c,v.os),!i[a]&&u&&"Unknown"!=u.platform&&(i[a]=u.platform.replace(/chrome os/i,"Chromium OS").replace(/macos/i,"Mac OS")),i},this.getResult=function(){return{ua:this.getUA(),browser:this.getBrowser(),engine:this.getEngine(),os:this.getOS(),device:this.getDevice(),cpu:this.getCPU()}},this.getUA=function(){return c},this.setUA=function(i){return c="string"==typeof i&&i.length>350?p(i,350):i,this},this.setUA(c),this};k.VERSION="0.7.34",k.BROWSER=l([a,n,"major"]),k.CPU=l(["architecture"]),k.DEVICE=l([o,t,r,"console",s,w,b,"wearable","embedded"]),k.ENGINE=k.OS=l([a,n]),"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=k),exports.UAParser=k):"function"==typeof define&&define.amd?define(function(){return k}):void 0!==i&&(i.UAParser=k);var y=void 0!==i&&(i.jQuery||i.Zepto);if(y&&!y.ua){var S=new k;y.ua=S.getResult(),y.ua.get=function(){return S.getUA()},y.ua.set=function(i){S.setUA(i);var e=S.getResult();for(var o in e)y.ua[o]=e[o]}}}("object"==typeof window?window:this);
